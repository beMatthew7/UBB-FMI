...
class RepositoryCarti:
    ...
    def store(self, carte: Carte):
        ...
        """
        if carte.get_id_carte() in self.__elements:
            raise ValueError("Exista deja cartea cu acest id.")
        self.__elements[carte.get_id_carte()] = carte
    ...
    def update(self, carte_actualizata: Carte):
        ...
        """
        if carte_actualizata.get_id_carte() not in self.__elements:
            raise ValueError("Nu există cartea cu id-ul dat.")
        self.__elements[carte_actualizata.get_id_carte()] = carte_actualizata
