...
from list_utils import add_to_list, copy_list_of_lists

def creeaza_calatorii_manager():
    """
...
def get_lista_calatorii(calatorii_manager):
    return calatorii_manager['lista_curenta']

def get_lista_undo(calatorii_manager):
    return calatorii_manager['lista_undo']

def set_lista_curenta(calatorii_manager, lista_curenta_noua):
    calatorii_manager['lista_curenta'] = lista_curenta_noua    

def adauga_la_lista_undo(calatorii_manager, lista):
    add_to_list(calatorii_manager['lista_undo'], lista)

def adaugare_la_lista(calatorii_manager, pachet_de_calatorie):
    """
    ...
    """
    adauga_la_lista_undo(calatorii_manager, copy_list_of_lists(get_lista_calatorii(calatorii_manager)))
    add_to_list(get_lista_calatorii(calatorii_manager), pachet_de_calatorie)
...
def undo(calatorii_manager):
    ...
    """
    if len(get_lista_undo(calatorii_manager)) == 0:
    ...
    lista_anterioara = get_lista_undo(calatorii_manager).pop()
    set_lista_curenta(calatorii_manager, lista_anterioara)
