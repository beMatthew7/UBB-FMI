...
class ControllerClienti:
    ...
    def populeaza_clienti_impliciti(self):
        self.adauga_client_nou(101, "Ion Popescu", "1234567890123")
        self.adauga_client_nou(102, "Maria Ionescu", "2234567890123")
        self.adauga_client_nou(103, "George Enescu", "5050912226721")
        self.adauga_client_nou(104, "Ana Marin", "5050912226722")
