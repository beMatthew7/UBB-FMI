...
class ControllerCarti:
    ...
    def add_default(self):
        ...
        self.adauga_carte(103, "Room", "Un roman captivant despre supraviețuire și legătura dintre mamă și fiu", "Emma Donoghue", 20)
        self.adauga_carte(104, "Jazz", "O meditație asupra iubirii, trădării și răscumpărării în Harlem", "Toni Morrison", 20)
